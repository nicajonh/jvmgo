...
type ClassFile struct{
	...
	fields []*MemberInfo
	methods []*MemberInfo
	atrributes []AttributeInfo
}


//奖从byte数组中读取ClassFile
...
//读取
 func (self *ClassFile) read(reader *ClassReader){
	 ...
	 //读取属性
	 self.attributes=self.attributes(reader,self.constantPool)

 }

 func (self *ClassFile) readAndMagic (reader *ClassReader){
